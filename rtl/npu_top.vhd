...
architecture rtl of npu_top is
    ...
    signal s_ofifo_write_feedback  : std_logic := '0';
...
begin
    ...
    u_controller : entity work.npu_controller
        ...
        port map (
            ...
            -- Backpressure e confirmação de escrita na FIFO
            fifo_ready_i  => s_fifo_ready_feedback,
            ofifo_write_i => s_ofifo_write_feedback
    ...
    u_datapath : entity work.npu_datapath
        ...
        port map (
            ...
            ofifo_write_feedback => s_ofifo_write_feedback
