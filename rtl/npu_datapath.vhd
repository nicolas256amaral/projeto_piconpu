...
entity npu_datapath is
    ...
    port (
        ...
        ofifo_write_feedback : out std_logic
...
architecture rtl of npu_datapath is
    ...
    signal ofifo_w_write       : std_logic;
    signal r_ofifo_w_write     : std_logic := '0';
...
begin
    ...
    ofifo_w_write       <= ofifo_w_valid and ofifo_w_ready;

    -- Registra a confirmação de escrita para quebrar o caminho combinacional
    -- FIFO -> datapath -> controller.
    process(clk)
    begin
    ...
    ofifo_write_feedback <= r_ofifo_w_write;
