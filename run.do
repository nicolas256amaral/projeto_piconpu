# ============================================================
# COMPILACAO E SIMULACAO ORGANIZADA - PICONPU
# ============================================================
...
# Simulacao
#
# -voptargs=+acc mantém sinais internos acessíveis na Wave.
# =========================
vsim -voptargs=+acc work.soc_tb_npu_trace

# Abre a Wave organizada.
do wave_piconpu_organizada.do
